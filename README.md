...
- **[Simple Pig Latin](./5-kyu/simple-pig-latin.md)**<br><sup>`REGULAR EXPRESSIONS` `ALGORITHMS`</sup>
- **[String incrementer](./5-kyu/string_incrementer.md)**<br><sup>`REGULAR EXPRESSIONS` `STRINGS`</sup>
- **[The Hashtag Generator](./5-kyu/the-hashtag-generator.md)**<br><sup>`STRINGS` `ALGORITHMS`</sup>
- **[Tic-Tac-Toe Checker](./5-kyu/tic-tac-toe-checker.md)**<br><sup>`ARRAYS` `ALGORITHMS`</sup>
- **[Value of x](./5-kyu/value-of-x.md)**<br><sup>`STRINGS` `ALGORITHMS`</sup>
- **[Weight for weight](./5-kyu/weight-for-weight.md)**<br><sup>`ALGORITHMS`</sup>
- **[Where my anagrams at?](./5-kyu/where-my-anagrams-at.md)**<br><sup>`STRINGS` `ALGORITHMS`</sup>
...
- **[ASCII Fun #3: Puzzle Tiles](./6-kyu/ascii-fun-3-puzzle-tiles.md)**<br><sup>`ASCII ART`</sup>
...
- **[Extract the IDs from the data set](./6-kyu/extract-the-ids-from-the-data-set.md)**<br><sup>`ARRAYS` `ALGORITHMS`</sup>
...
- **[Take a Number And Sum Its Digits Raised To The Consecutive Powers And ....¡Eureka!!](./6-kyu/take-a-number-and-sum-its-digits-raised-to-the-consecutive-powersand-eureka.md)**<br><sup>`FUNDAMENTALS` `MATHEMATICS`</sup>
...
- **[Title Case](./6-kyu/title-case.md)**<br><sup>`STRINGS` `FUNDAMENTALS`</sup>
- **[Tombola - validation](./6-kyu/tombola-validation.md)**<br><sup>`ARRAYS` `FUNDAMENTALS`</sup>
...
- **[Valid Phone Number](./6-kyu/valid-phone-number.md)**<br><sup>`REGULAR EXPRESSIONS` `ALGORITHMS`</sup>
...
- **[Write Number in Expanded Form](./6-kyu/write-number-in-expanded-form.md)**<br><sup>`STRINGS` `MATHEMATICS` `ALGORITHMS` `FUNDAMENTALS`</sup>
- **[Your order, please](./6-kyu/your-order-please.md)**<br><sup>`STRINGS` `FUNDAMENTALS`</sup>
- **[Zero-plentiful Array](./6-kyu/zero-plentiful-array.md)**<br><sup>`FUNDAMENTALS`</sup>
- **[Ziiiiip!](./6-kyu/ziiiiip.md)**<br><sup>`ARRAYS` `FUNDAMENTALS`</sup>
...
- **[Get key/value pairs as arrays](./7-kyu/get-key-value-pairs-as-arrays.md)**<br><sup>`ARRAYS` `FUNDAMENTALS`</sup>
...
- **[How many e-mails we sent today?](./7-kyu/how-many-e-mails-we-sent-today.md)**<br><sup>`FUNDAMENTALS` `LOGIC` `MATHEMATICS`</sup>
...
- **[isAN(value)](./7-kyu/is-an-value.md)**<br><sup>`FUNDAMENTALS`</sup>
...
- **[Sorted Union](./7-kyu/sorted-union.md)**<br><sup>`ARRAYS` `LISTS` `ALGORITHMS` `SORTING`</sup>
...
- **[Not so black box](./8-kyu/not-so-black-box.md)**<br><sup>`PUZZLES`</sup>
- **[OOP: Object Oriented Piracy](./8-kyu/oop-object-oriented-piracy.md)**<br><sup>`OBJECT-ORIENTED PROGRAMMING` `FUNDAMENTALS`</sup>
- **[Opposites Attract](./8-kyu/opposites-attract.md)**<br><sup>`FUNDAMENTALS`</sup>
